...
export const translations = {
  gu: {
    ...
    loadingUnloadingCharges: "ભરાય ઉત્તરાય",
    loadingUnloadingChargesUdhar: "ભરાય",
    loadingUnloadingChargesJama: "ઉત્તરાય",
    vehicleRent: "વાહન ભાડું",
    deposit: "ડિપોઝિટ",
    extraCostOption: "અતિરિક્ત ખર્ચ",
    discounts: "છૂટ",
    ...
    damagedRepaired: 'રિપેર થયેલ',
    markLost: 'ગુમ ઉમેરો',
    markDamaged: 'નુકસાન ઉમેરો',
    lostExceedsOutstanding: 'પરત + ગુમ + નુકસાન બાકી કરતાં વધુ ન હોઈ શકે',
    inner: 'ઈનર',
    outer: 'આઉટર',
    credit: 'ક્રેડિટ',
    extra: 'વધારે',
    ...
    downloadStockPhoto: 'ફોટો ડાઉનલોડ',
    generatingStockPhoto: 'સ્ટોક ફોટો બની રહ્યો છે...',
    stockPhotoDownloaded: 'સ્ટોક ફોટો ડાઉનલોડ થયો',
    stockPhotoFailed: 'સ્ટોક ફોટો બનાવવામાં નિષ્ફળ',
    stockPhotoDateTime: 'તારીખ અને સમય',
    ...
    damaged_stock: 'નુકસાન થયેલ સ્ટોક',
    ...
    challanBook: 'ચલણ બુક',
    udharChallans: 'ભરાય ચલણ',
    jamaChallans: 'ઉત્તરાય ચલણ',
    ...
    payable: "ચૂકવવાપાત્ર",
    reorderSizesTitle: "સાઈઝનો ક્રમ ગોઠવો",
    reorderSizesButton: "સાઈઝ ગોઠવો",
    shuttering: "શટરિંગ",
    jack: "જેક",
    cuplock: "કપલોક",
    other: "અન્ય",
    ...
    cost: "ખર્ચ",
    discount: "છૂટ",
    showHidden: "છુપાવેલ બતાવો",
    hideHidden: "છુપાવેલ છુપાવો",
    settings: "સેટિંગ્સ",
    billCalculationSettings: "બિલ ગણતરી સેટિંગ્સ",
    dateSortingMethod: "તારીખ ક્રમિકતા પદ્ધતિ",
    standardSorting: "માનક પદ્ધતિ",
    jamaFirstSorting: "જમા પ્રથમ",
    standardSortingDesc: "જ્યારે ગ્રાહક પ્લેટ પાછી આપે ત્યારે તે દિવસે પણ ભાડું ચાર્જ થાય છે. (જમા અસર: બીજા દિવસથી)",
    jamaFirstSortingDesc: "જ્યારે ગ્રાહક પ્લેટ પાછી આપે ત્યારે તે જ દિવસે ભાડું બંધ થઈ જાય છે. (ઓછો ચાર્જ)",
    languageSettings: "ભાષા સેટિંગ્સ",
    selectLanguage: "ભાષા પસંદ કરો",
    settingsSaved: "સેટિંગ્સ સાચવી લેવામાં આવી છે",
    billSharingSettings: "બિલ શેરિંગ સેટિંગ્સ",
    billGenerationFormatSettings: "બિલ ફોર્મેટ સેટિંગ્સ (PDF / ફોટો JPG)",
    billGenerationFormatDesc: "બિલ બનાવતી વખતે અથવા ડાઉનલોડ કરતી વખતે કયા ફોર્મેટમાં (PDF કે ફોટો JPG) બિલ જનરેટ કરવું તે પસંદ કરો. દરેક કેટેગરી માટે અલગ પણ રાખી શકો છો.",
    billFormatPDF: "પીડીએફ (PDF Document)",
    billFormatJPG: "ફોટો (JPG Image)",
    shareBillMode: "બિલ શેર કરવાની પદ્ધતિ",
    shareAsImage: "ફોટો (JPEG) તરીકે શેર કરો",
    shareAsText: "ટેક્સ્ટ મેસેજ (WhatsApp) તરીકે શેર કરો",
    shareBillModeDesc: "બિલ બુકમાંથી બિલ શેર કરતી વખતે ફોટો મોકલવો છે કે સીધો વોટ્સએપ પર લખાણ (ટેક્સ્ટ) મોકલવું છે તે નક્કી કરો.",
    backup: "બેકઅપ",
    ledgerDownloadSettings: "ખાતાવહી ડાઉનલોડ સેટિંગ્સ",
    defaultLedgerDownloadFormat: "ડિફોલ્ટ ખાતાવહી ડાઉનલોડ પદ્ધતિ",
    detailedFormatDesc: "બધા સાઈઝના કૉલમ અને સંપૂર્ણ વિગતો સાથે ડાઉનલોડ કરો.",
    simpleFormatDesc: "માત્ર ચલણ નંબર, તારીખ, કુલ નંગ અને ડ્રાઇવર વિગતો બતાવશે.",
    splitFormatDesc: "ડાબી બાજુ બધા ઉધાર ચલણ અને જમણી બાજુ બધા જમા ચલણ સામસામે બતાવશે.",
    detailed: "વિગતવાર",
    simple: "સરળ",
    split: "સામસામે",
    newSize: "નવી સાઈઝ",
    createNewSize: "નવી સાઈઝ બનાવો",
    sizeName: "સાઈઝનું નામ",
    category: "કેટેગરી",
    confirmAddSize: "કન્ફર્મ સાઈઝ ઉમેરો",
    udharChallanSubtitle: "નવું ઉધાર ચલણ બનાવો",
    ...
    createAllBills: "બધા બિલ બનાવો",
    creatingBills: "બિલ બની રહ્યા છે...",
    selectClientsForBilling: "બિલિંગ માટે ગ્રાહકો પસંદ કરો",
    selectAllClients: "બધા પસંદ કરો",
    deselectAllClients: "બધા કાઢી નાખો",
    monthlyBillCronSettings: "ઓટોમેટિક માસિક બિલિંગ",
    enableMonthlyBillCron: "દર મહિનાની 1લી તારીખે બિલ બનાવો",
    enableMonthlyBillCronDesc: "દર મહિનાની 1લી તારીખે બાકી બિલિંગવાળા બધા ગ્રાહકો માટે ડ્રાફ્ટ બિલ આપોઆપ બનશે. બંધ કરવાથી શેડ્યૂલ બિલિંગ અટકશે; 'બધા બિલ બનાવો' બટન ચાલુ રહેશે.",
    cronEnabled: "માસિક બિલિંગ ચાલુ",
    cronDisabled: "માસિક બિલિંગ બંધ",
    ...
    locked: "લૉક",
    defaultWord: "ડિફોલ્ટ",
    customDailyRents: "કસ્ટમ રોજનું ભાડું",
    clientsWord: "ગ્રાહકો",
    cancelText: "રદ્દ કરો",
    saveText: "સાચવો",
    clientsFound: "ગ્રાહકો મળ્યા",
    noClientsFound: "કોઈ ગ્રાહક મળ્યા નહીં",
    driverPhone: "ડ્રાઈવર મોબાઈલ",
    vehicleNumber: "ગાડી નંબર",
    fontSizeSettings: "ફોન્ટ સાઈઝ સેટિંગ્સ",
    ...
    reset: "રીસેટ",
    fontPreviewText: "ખાતા કેન્દ્ર — Khata Kendra",
    fontPreviewSub: "બિલ · ચલણ · ખાતાવહી · સ્ટોક",
    extraFieldsSettings: "વધારાના ફિલ્ડ સેટિંગ્સ",
    enableDriverMobileVehicle: "ડ્રાઈવર મોબાઈલ અને ગાડી નંબર ચાલુ કરો",
    enableDriverMobileVehicleDesc: "જમા અને ઉધાર ચલણ બનાવતી વખતે ડ્રાઇવરનો મોબાઈલ નંબર અને ગાડી નંબરના ખાના બતાવો.",
    creatingChallan: "ચલણ બની રહ્યું છે...",
    generatingJPEG: "ફોટો બની રહ્યો છે...",
    deletingChallan: "ચલણ કાઢી નાખવામાં આવી રહ્યું છે...",
  },
  en: {
    // Landing Page
    ...
    loadingUnloadingCharges: "Loading & Unloading",
    loadingUnloadingChargesUdhar: "Loading",
    loadingUnloadingChargesJama: "Unloading",
    vehicleRent: "Vehicle Rent",
    deposit: "Deposit",
    extraCostOption: "Extra Cost Options",
    discounts: "Discounts",
    ...
    adjustLostStock: 'Adjust Lost Stock',
    adjustDamagedStock: 'Adjust Damaged Stock',
    lostRecovered: 'Recovered',
    damagedRepaired: 'Repaired',
    markLost: 'Mark Lost',
    markDamaged: 'Mark Damaged',
    lostExceedsOutstanding: 'Returned + lost + damaged cannot exceed outstanding',
    inner: 'Inner',
    outer: 'Outer',
    credit: 'credit',
    extra: 'extra',
    ...
    downloadStockPhoto: 'Download Photo',
    generatingStockPhoto: 'Generating stock photo...',
    stockPhotoDownloaded: 'Stock photo downloaded',
    stockPhotoFailed: 'Failed to generate stock photo',
    stockPhotoDateTime: 'Date & Time',
    journal: 'Journal',
    ...
    udharChallans: 'Loading Challans',
    jamaChallans: 'Unloading Challans',
    ...
    payable: "Payable",
    reorderSizesTitle: "Reorder Sizes",
    reorderSizesButton: "Reorder Sizes",
    ...
    settings: "Settings",
    billCalculationSettings: "Bill Calculation Settings",
    dateSortingMethod: "Date Sorting Method",
    standardSorting: "Standard Method",
    jamaFirstSorting: "Jama First",
    standardSortingDesc: "Return day is charged. Plates leave the balance the day AFTER return. (Client pays for return day)",
    jamaFirstSortingDesc: "Return day is NOT charged. Plates leave the balance on the same day of return. (Less rent for client)",
    languageSettings: "Language Settings",
    selectLanguage: "Select Language",
    settingsSaved: "Settings saved successfully",
    backup: "Backup",
    ledgerDownloadSettings: "Ledger Download Settings",
    defaultLedgerDownloadFormat: "Default Ledger Download Format",
    detailedFormatDesc: "Downloads the ledger with columns for all sizes and full details.",
    simpleFormatDesc: "Downloads with only challan numbers, dates, total quantities, and driver info.",
    splitFormatDesc: "Shows Udhar challans on the left side and Jama challans on the right side side-by-side.",
    ...
    sizeName: "Size Name",
    category: "Category",
    confirmAddSize: "Add Size",
    udharChallanSubtitle: "Create new udhar challan",
    jamaChallanSubtitle: "Create new jama challan for returned items",
    challanBookSubtitle: "View and manage all challans",
    billingSubtitle: "Choose client for billing",
    createAllBills: "Create All Bills",
    creatingBills: "Creating bills...",
    selectClientsForBilling: "Select clients for billing",
    selectAllClients: "Select all",
    deselectAllClients: "Deselect all",
    monthlyBillCronSettings: "Automatic Monthly Billing",
    enableMonthlyBillCron: "Auto-create bills on the 1st",
    enableMonthlyBillCronDesc: "On the 1st of every month, draft bills are created automatically for all clients with pending billing. Turn off to stop scheduled billing; the Create All Bills button keeps working either way.",
    cronEnabled: "Monthly billing on",
    cronDisabled: "Monthly billing off",
    settingsSubtitle: "Configure application behavior and defaults",
    ...
    reset: "Reset",
    fontPreviewText: "ખાતા કેન્દ્ર — Khata Kendra",
    fontPreviewSub: "Bills · Challans · Ledger · Stock",
    extraFieldsSettings: "Feature Visibility Settings",
    enableDriverMobileVehicle: "Enable Driver Mobile Number & Vehicle",
    enableDriverMobileVehicleDesc: "Show fields for Driver Mobile and Vehicle details during Jama and Udhar challan creation.",
    billSharingSettings: "Bill Sharing Settings",
    billGenerationFormatSettings: "Bill Generation Format (PDF / Photo JPG)",
    billGenerationFormatDesc: "Choose whether bills are generated and downloaded as PDF or photo JPG. You can also configure different formats for each category.",
    billFormatPDF: "PDF Document",
    billFormatJPG: "Photo (JPG Image)",
    shareBillMode: "Bill Sharing Mode",
    shareAsImage: "Share as Image (JPEG)",
    shareAsText: "Share as Text (WhatsApp)",
    shareBillModeDesc: "Choose whether to generate/share a bill image or send a direct text message on WhatsApp when sharing a bill.",
    due: "Due",
    view: "View",
    share: "Share",
    locked: "Locked",
    defaultWord: "Default",
    customDailyRents: "Custom Daily Rent",
    clientsWord: "clients",
    cancelText: "Cancel",
    saveText: "Save",
    clientsFound: "Clients found",
    noClientsFound: "No clients found",
    creatingChallan: "Creating challan...",
    generatingJPEG: "Generating JPEG...",
    deletingChallan: "Deleting challan...",
  },
};
